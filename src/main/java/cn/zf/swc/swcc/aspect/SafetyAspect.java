...
public class SafetyAspect {
     ...
     * Pointcut 切入点
     * 匹配
     * cn.zf.swc.swcc.sys.*.controller、
     * cn.zf.swc.swcc.*.controller包下面的所有方法
     */
    @Pointcut(value = "execution(public * cn.zf.swc.swcc.sys.*.controller.*.*(..)) || " +
            "execution(public * cn.zf.swc.swcc.*.controller.*.*(..))")
