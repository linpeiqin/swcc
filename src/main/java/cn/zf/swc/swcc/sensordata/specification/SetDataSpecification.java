...
public class SetDataSpecification {
    ...
    public Specification<SetData> getSetDataSpecification(SetDataVo setDataVo) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            if (!SecurityUtil.hasAuthentication("ROLE_SUB_ADMIN") && !SecurityUtil.hasAuthentication("ROLE_SETDATA_SELECT")) {
