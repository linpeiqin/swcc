        ...
        try {
            ...
            for (Object key : srcBean.keySet()) {
                ...
                if (targetPropertyType == null){
                    targetPropertyType = targetBean.getPropertyType(targetPropertyName + "Vo");
                    flag = 2;
                }
                if (targetPropertyType == null){
                    targetPropertyType = targetBean.getPropertyType(targetPropertyName.substring(0,targetPropertyName.length()-2));
                    flag = 3;
                }
                ...
                //类型不相等，比如：User与UserVo
                    ...
                    if (flag == 2){
                        srcPropertyName = targetPropertyName+"Vo";
                    }
                    if (flag == 3){
                        srcPropertyName = targetPropertyName.substring(0,targetPropertyName.length()-2);
                    }
                    //设置目标对象属性值
