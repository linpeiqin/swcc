...
public class LargeScreenUtil {
    ...
    public LargeScreenVo setSetStatus(Long wcInfoId, LargeScreenVo largeScreenVoB) {
        if (wcInfoId == null) {
            return null;
        }
        LargeScreenVo largeScreenVo = largeScreenVoB;
        ...
        for (SetStatus setStatus : setStatuses) {
         //   System.out.println(setStatus.getStatusList());
            if (setStatus.getMacCode().equals(wcInfoVo.getMacCode()) && setStatus.getWcId().equals(wcInfoVo.getWcId())) {
                largeScreenVo.setStatusList(setStatus.getStatusList());
                break;
            }
        }
        return largeScreenVo;
    ...
    public LargeScreenVo getLargeScreenInfo(Long wcInfoId) {
        ...
        largeScreenVo = setSetStatus(wcInfoId, largeScreenVo);
        return largeScreenVo;
    }
}
