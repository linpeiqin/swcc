            ...
            r.events = {
                flexible: function () {
                    ...
                    r.strToWin(e.window).layui.admin.popupRight(t.extend({
                        id: "layer-theme",
                        url: e.url || "/assets/libs/templets/tpl-theme.html"
                    }, r.parseLayerOption(e)))
                }, note: function () {
                    var e = r.util.deepClone(t(this).data());
                    r.strToWin(e.window).layui.admin.popupRight(t.extend({
                        id: "layer-note",
                        url: e.url || "/assets/libs/templets/tpl-note.html"
                    }, r.parseLayerOption(e)))
                }, message: function () {
                    var e = r.util.deepClone(t(this).data());
                    r.strToWin(e.window).layui.admin.popupRight(t.extend({
                        id: "layer-notice",
                        url: e.url || "/assets/libs/templets/tpl-message.html"
                    }, r.parseLayerOption(e)))
                }, psw: function () {
                    var e = r.util.deepClone(t(this).data());
                    r.strToWin(e.window).layui.admin.open(t.extend({
                        ...
                        title: "修改密码",
                        shade: 0,
                        url: e.url || "/assets/libs/templets/tpl-password.html"
                    }, r.parseLayerOption(e)))
                }, logout: function () {
                    var e = r.util.deepClone(t(this).data());
                ...
                console.log(e), e || (e = "/assets/libs/templets/tpl-lock-screen.html");
