        ...
        layui.define(["jquery"], (function (e) {
            ...
            e("base", {
                isEmpty: function (e) {
                    ...
                    if (!comm.isEmpty(e)) return e.substring(0, 1).toUpperCase() + e.substring(1)
                }, upDigit: function (e) {
                    var t = ["角", "分", "厘"], r = ["零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖"],
                        n = [["元", "万", "亿"], ["", "拾", "佰", "仟"]], o = e < 0 ? "欠人民币" : "人民币";
                    e = Math.abs(e);
                    for (var a = "", i = 0; i < t.length; i++) a += (r[Math.floor(10 * e * Math.pow(10, i)) % 10] + t[i]).replace(/零./, "");
                    a = a || "整", e = Math.floor(e);
                    for (i = 0; i < n[0].length && e > 0; i++) {
                        for (var u = "", c = 0; c < n[1].length && e > 0; c++) u = r[e % 10] + n[1][c] + u, e = Math.floor(e / 10);
                        a = u.replace(/(零.)*零$/, "").replace(/^$/, "零") + n[0][i] + a
                    }
                    return o + a.replace(/(零.)*零元/, "元").replace(/(零.)+/g, "零").replace(/^整$/, "零元整")
                }, setCookie: function (e, t, r) {
                    var n = new Date;
                    n.setDate(n.getDate() + r), document.cookie = e + "=" + t + ";expires=" + n
                    ...
                    (e = e || {}).type = e.type.toUpperCase() || "POST", e.url = e.url || "", e.async = e.async || !0, e.data = e.data || null, e.success = e.success || function () {
                    }, e.error = e.error || function () {
                    };
                    var t = null;
                    t = XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
                    var r = [];
                    for (var n in e.data) r.push(n + "=" + e.data[n]);
                    var o = r.join("&");
                    "POST" === e.type.toUpperCase() ? (t.open(e.type, e.url, e.async), t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"), t.send(o)) : "GET" === e.type.toUpperCase() && (t.open(e.type, e.url + "?" + o, e.async), t.send(null)), t.onreadystatechange = function () {
                        4 == t.readyState && 200 == t.status ? e.success(t.responseText) : e.error(t.responseText)
                    }
                }, istype: function (e, t) {
                    if (t) var r = t.toLowerCase();
                    switch (r) {
                        case"string":
                    ...
                    return n = t.split(/\s+/), o = this.createKeyExp(n), i = e, a = new RegExp(o, "g"), (i = i.replace(/<\/?[^>]*>/g, "")).replace(a, "<" + u + ">$1</" + u + ">")
                }, get_url_param: function (e) {
                    for (var t = (e = e || window.location.href).substring(e.indexOf("?") + 1).split("&"), r = {}, n = 0, o = t.length; n < o; n++) {
                        var a = t[n].indexOf("=");
                        if (-1 != a) {
                            var i = t[n].substring(0, a), u = window.decodeURIComponent(t[n].substring(a + 1));
                            r[i] = u
                        }
                    }
                    return r
                    ...
                    var t = [];
                    for (var r in e) null != e[r] && "" != e[r] && t.push(r + "=" + e[r]);
                    return t.join("&")
                    ...
                    if (!t) return e;
                    for (var r = t.split(",").reverse(), n = e.slice(0), o = 0, a = r.length; o < a; o++) n.sort((function (e, t) {
                        return e[r[o]] - t[r[o]]
                    }));
                    return n
                }
